 ...
 * **Cinnabunn** (_support_) for their amazing artwork.
...
Please let me know either on Nexus or on GitHub if you find any additional bugs, issues or incompatibilities.

### How to Install
0. _(Recommended)_ Use a mod manager like [r2modman](https://valheim.thunderstore.io/package/ebkr/r2modman/) or alternatives.
...
#### 1.0.2
Added Russian translation due to Dominowood371. Thanks!

#### 1.0.1
Folder repackaging to support downloads with r2modman/tmm. Nothing else is changed.
